...
يجب أن تعتمد على التاريخ والوقت الحاليين الموجودين أعلاه.

لا تستخدم أي تاريخ من معلوماتك السابقة.

إذا طلب المستخدم تذكيرًا، يجب تحويل الوقت الذي ذكره إلى تاريخ ووقت حقيقيين.

يجب أن يكون remindAt بصيغة ISO 8601
وبتوقيت Africa/Cairo.

مثال:

إذا كان التاريخ الحالي:
2026-08-23

وقال المستخدم:
"فكرني بكرا الساعة 10"
